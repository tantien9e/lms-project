...
const AddCourse = () => {
  ...
  return (
    <div className='h-screen overflow-y-auto flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} action="">
        ...
        <div className='flex items-center justify-between flex-wrap'>
          ...
          <div className='flex flex-col gap-1'>
            <p>Course Price</p>
            <input onChange={e => setCoursePrice(e.target.value)} value={coursePrice} type="number" placeholder='0' className='outline-none w-28 md:py-2.5 py-2 px-3 rounded border border-gray-500' required />
          </div>
          {/* Course Thumbnail */}
        ...
        <div className='flex flex-col gap-1'>
          <p>Discount %</p>
          <input type="number" onChange={e => setDiscount(e.target.value)} value={discount} placeholder='0' min={0} max={100} className='outline-none w-28 md:py-2.5 py-2 px-3 rounded border border-gray-500' required />
        </div>
